# -*- coding: utf-8 -*-
"""
Created on Fri Feb 12 14:20:17 2021
...
while True:
	...
	if num_frames < 60:
		...
		if hand is not None:
				...
				# Display count
				cv2.putText(frame_copy, str(fingers)+str(stars), (70, 45), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
	...
	cv2.imshow("Rating on the Scale of 5", frame_copy)
